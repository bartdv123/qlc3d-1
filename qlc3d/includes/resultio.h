...
namespace ResultIO
{
         ...
         * @param q Q-tensor
         * @param tiltE splay_energy
         * @param twistE twist_energy
         * @param bendE bend_energy
         * @param elasticE elastic_energy
         * @param thermoE thermotropic_energy
         * @param electricE electric_energy
         * @param totalE total_energy
