                            ...
                            const Simu &simu)
{
    ...
    { // LOOP OVER DIMENSIONS
        for (idx j = 0; j < npLC; j++)
        { // LOOP OVER EACH NODE IN DIMENSION i
               ...
               Alignment *alignment)
{
    ...
    { // Q-TENSOR SOLUTION LOOP
        ...
        if (isTimeStepping)
        { // make Non-linear Crank-Nicholson RHS
        ...
        else if (fabs(maxdq) < simu->getMaxError())
